...
#define CUSTOM_BOARD_2						2  //!< the first custom board, change name to your needs.

#if CUSTOM_BOARD == CUSTOM_BOARD_TEMPLATE
# include  "custom_board_template.h"
#elif CUSTOM_BOARD == CUSTOM_BOARD_2 	//change name to your needs!
# include  "custom_board2.h"			//change name to your needs!
#else
